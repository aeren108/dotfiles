...
function _omb_theme_PROMPT_COMMAND() {
    local user_name="${_omb_prompt_bold_white}\u${_omb_prompt_reset_color}"
    local base_directory="${_omb_prompt_blue}\W${_omb_prompt_reset_color}"
    ...
    local arrow="${_omb_prompt_purple}➜${_omb_prompt_reset_color}"
    local dollar="${_omb_prompt_bold_white}\$${_omb_prompt_reset_color} "
